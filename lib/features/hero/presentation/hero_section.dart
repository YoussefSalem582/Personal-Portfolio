...
import '../../../core/widgets/hero_section/hero_action_buttons_widget.dart';
import '../../../core/widgets/about_section/social_links_widget.dart';
import 'bloc/hero_bloc.dart';
import 'bloc/hero_state.dart';
                        ...
                        builder: (context, state) {
                          if (state is HeroLoaded) {
                            return Column(
                              ...
                              children: [
                                HeroTextWidget(
                                    fullName: state.content.fullName),
                                ...
                                SocialLinksWidget(
                                    links: state.content.socialLinks),
                              ],
                            );
                          }
                          if (state is HeroFailure) {
              ...
              builder: (context, state) {
                if (state is HeroLoaded) {
                  return Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      HeroTextWidget(fullName: state.content.fullName),
                      const SizedBox(height: AppTheme.spacingXL),
                      HeroActionButtonsWidget(
                        onNavigateToSection: widget.onNavigateToSection,
                      ),
                      const SizedBox(height: AppTheme.spacingXL),
                      SocialLinksWidget(links: state.content.socialLinks),
                    ],
                  );
                }
                if (state is HeroFailure) {
