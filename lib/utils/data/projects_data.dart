...
class ProjectsData {
  static final List<Project> projects = [
    Project(
      ...
      shortDescription:
          '👨‍👩‍👧‍👦 Modern family management app with real-time location tracking, meal monitoring, mood sharing, and social wall',
      description:
          'FamilyLink is a comprehensive family management application built with Flutter, featuring real-time location tracking, meal monitoring, mood sharing, and a family social wall. '
          'The app helps families stay connected by providing home dashboard with family member status, activity statistics with members at home/away tracking, location display with last seen timestamps, '
          'and member detail sheets. The meals module tracks all meals (breakfast, lunch, dinner, snacks), allows marking meals as eaten or skipped, includes calendar navigation to view any date, '
          'provides meal history with full persistence, shows family meal overview and statistics, and prevents duplicate meal entries.\n\n'
          'Features an advanced mood tracker where family members can share moods with 8 emoji options, add optional notes, view family mood history, track daily moods, '
          'and see mood statistics and insights with complete data persistence. The interactive map uses OpenStreetMap integration (no API key needed), visualizes family member locations, '
          'includes custom markers with user initials, provides location privacy controls, and uses a free open-source solution.\n\n'
          'Built with MVVM architecture using GetX for state management, organized with clean separation of concerns through modular structure (core/, data/, modules/, widgets/). '
          'The app includes a comprehensive demo mode that allows testing all features without Firebase setup, viewing sample family data, navigating through all modules, and experiencing the full UI/UX. '
          'Phase 1 complete with all UI modules and demo mode; Phase 2 planned for Firebase integration, push notifications, and production deployment.',
      technologies: [
        'Flutter 3.x',
        'Dart 3.9.2',
        'GetX',
      ...
      githubUrl: 'https://github.com/YoussefSalem582/Family-Link',
      liveUrl: 'https://youssefsalem582.github.io/Family-Link/',
      imageUrl: FamilyLinkImages.appLogo,
      galleryImages: [
        // Splash & Onboarding
        FamilyLinkImages.splashScreen,
        FamilyLinkImages.onboarding1,
        FamilyLinkImages.onboarding2,
        FamilyLinkImages.onboarding3,
        FamilyLinkImages.onboarding4,
        FamilyLinkImages.onboarding5,

        // Authentication
        FamilyLinkImages.loginOrSignupScreen,
        FamilyLinkImages.loginScreen,
        FamilyLinkImages.signupScreen,

        // Home Dashboard
        FamilyLinkImages.homeScreen,
        FamilyLinkImages.homeScreen2,
        FamilyLinkImages.homeScreen3,

        // Meals Module
        FamilyLinkImages.mealsScreen,
        FamilyLinkImages.mealsScreen2,
        FamilyLinkImages.mealsScreen3,

        // Mood Module
        FamilyLinkImages.moodsScreen,
        FamilyLinkImages.moodsScreen2,
        FamilyLinkImages.moodsScreen3,

        // Map Module
        FamilyLinkImages.mapScreen,
        FamilyLinkImages.mapScreen2,

        // Social/Wall Module
        FamilyLinkImages.socialScreen,
        FamilyLinkImages.socialScreen2,
        FamilyLinkImages.socialScreen3,
        FamilyLinkImages.socialScreen4,
        FamilyLinkImages.socialScreen5,

        // Profile & Settings
        FamilyLinkImages.profileScreen,
